...
import net.cryptic.digital.resources.screen.slot.ModResultSlot;
...
public class SimulatorBlockMenu extends AbstractContainerMenu {
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 116; // This is the height in pixels of your arrow
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.SIMULATOR_BLOCK.get());
    }
